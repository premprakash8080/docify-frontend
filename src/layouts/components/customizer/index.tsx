...
const Customizer = () => {
    ...
    return (
      <Offcanvas show={customizer.isOpen} onHide={customizer.toggle} placement="end" className="overflow-hidden">
        <div className="d-flex justify-content-between text-bg-primary gap-2 p-3" style={{ backgroundImage: `url(${pattern})` }}>
          <div>
                ...
                <Col sm={6} key={idx}>
                  <div className="form-check card-radio">
                    ...
                    <label className="form-check-label p-0 w-100" htmlFor={`skin-${item.skin}`}>
                      <img src={item.image} alt="layout-img" className="img-fluid" width={167.5} height={111.66} />
                    </label>
                  </div>
