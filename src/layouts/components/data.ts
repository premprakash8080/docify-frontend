...
export const menuItems: MenuItemType[] = [
  ...
  { key: 'notebooks', label: 'Notebooks', icon: LuNotebookText, url: '/notebooks' },
  { key: 'tags', label: 'Tags', icon: LuTag, url: '/tags' },

  { key: 'Collaboration', label: 'Collaboration', isTitle: true },
  { key: 'shared-with-me', label: 'Shared with me', icon: LuShare, url: '/shared-with-me' },
  { key: 'spaces', label: 'Spaces', icon: LuUsers, url: '/spaces' },
]
