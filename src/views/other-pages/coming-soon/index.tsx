              ...
              <div className="mt-auto">
                <div className="p-2 text-center">
                  ...
                  <Row className="text-center justify-content-center my-4 g-2">
                    <Col xs={6} sm={4} md={3} lg>
                      <div className="bg-light bg-opacity-50 py-3 px-2 rounded">
                        <h2 id="days" className="fw-bold text-primary fs-36">{days}</h2>
                        <p className="fw-semibold fs-xs mb-0">Days</p>
                      </div>
                    </Col>
                    <Col xs={6} sm={4} md={3} lg>
                      <div className="bg-light bg-opacity-25 py-3 px-2 rounded">
                        <h3 id="hours" className="fw-bold text-primary fs-36">{hours}</h3>
                        <p className="fw-semibold fs-xs mb-0">Hours</p>
                      </div>
                    </Col>
                    <Col xs={6} sm={4} md={3} lg>
                      <div className="bg-light bg-opacity-50 py-3 px-2 rounded">
                        <h3 id="minutes" className="fw-bold text-primary fs-36">{minutes}</h3>
                        <p className="fw-semibold fs-xs mb-0">Minutes</p>
                      </div>
                    </Col>
                    <Col xs={6} sm={4} md={3} lg>
                      <div className="bg-light bg-opacity-25 py-3 px-2 rounded">
                        <h3 id="seconds" className="fw-bold text-primary fs-36">{seconds}</h3>
                  ...
                  <div className="app-search w-xl-75 mx-auto input-group mt-3 rounded-pill">
                    ...
                    <Button variant='secondary' type="button">Notify me!</Button>
                  </div>
                </div>
              </div>
