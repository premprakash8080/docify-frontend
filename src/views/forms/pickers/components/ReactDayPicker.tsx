...
const CaptionLayout = () => {
  return (
    <>
      ...
      <DayPicker animate mode="single" captionLayout="dropdown" />
    </>
  )
}
...
const MultipleDayPicker = () => {
  return (
    <>
      ...
      <DayPicker animate mode="multiple" />
    </>
  )
}
...
const TimeZoneAndLocale = () => {
  return (
    <>
      ...
      <DayPicker animate mode="single" timeZone="Asia/Kolkata" locale={gu} />
    </>
  )
}
...
const RtlDayPicker = () => {
  return (
    <>
      ...
      <DayPicker animate mode="single" timeZone="Europe/Berlin" locale={arTN} dir="rtl" />
    </>
  )
}
  ...
  return (
    <Card>
      ...
      <CardBody>
        ...
        <Link className="btn btn-link p-0 fw-semibold" to="https://daypicker.dev/" target="_blank">
          React DayPicker
