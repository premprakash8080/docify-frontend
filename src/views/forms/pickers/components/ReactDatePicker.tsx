...
const BasicDatePicker = () => {
  ...
  return (
    <Row className="g-4">
      ...
      <Col lg={6}>
        <DatePicker className="form-control w-100" selected={selected} onChange={(date) => setSelected(date)} />
      </Col>
    </Row>
  )
}
...
const MultipleMonthsDatePicker = () => {
  ...
  return (
    <Row className="g-4">
      ...
      <Col lg={6}>
        <DatePicker className="form-control w-100" selected={selected} onChange={(date) => setSelected(date)} monthsShown={2} />
      </Col>
    </Row>
  )
}
...
const DatePickerDateFormat = () => {
  ...
  return (
    <Row className="g-4">
      ...
      <Col lg={6}>
        <DatePicker className="form-control" selected={selected} onChange={(date) => setSelected(date)} dateFormat="yyyy-MM-dd" />
      </Col>
    </Row>
  )
}
