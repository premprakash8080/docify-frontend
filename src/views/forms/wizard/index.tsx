...
import { useWizard ,Wizard as WizardReact} from 'react-use-wizard'
      ...
      <Row>
        ...
        <Col xl={6}>
          <FormGroup className="mb-3">
            ...
            <FlatPicker className="form-control" placeholder="Select you DOB" options={{ dateFormat: 'd M, Y' }} name="dob" required />
          </FormGroup>
        </Col>
      </Row>
      ...
      <Row className="justify-content-center">
        <Col xxl={12}>
          ...
          <ComponentCard title="Wizard with Progress">
            <WizardReact header={<Header withProgress />}>
              <Step1 />
              <Step2 />
              <Step3 />
              <Step4 />
