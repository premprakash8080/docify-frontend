...
import { options, states } from '@/views/forms/other-plugins/data'
  ...
  return (
    <Card>
      ...
      <CardBody>
        ...
        <Link className="btn btn-link p-0 fw-semibold" to="https://ericgio.github.io/react-bootstrap-typeahead/" target="_blank">
