import {sellerProducts, type SellerProductType} from '@/views/ecommerce/sellers/[sellerId]/data'
                ...
                <div className="d-flex align-items-center">
                    ...
                    <div>
                        <h5 className="mb-0 fw-normal">
                            <Link data-sort="product" to="/product/1" className="link-reset">
                                {row.original.name}
                            </Link>
                        </h5>
                    </div>
        ...
        <Card>
            <CardHeader className="border-light justify-content-between">
                ...
                <div className="d-flex gap-1">
                    ...
                    <Link to="/add-product" className="btn btn-danger ms-1">
