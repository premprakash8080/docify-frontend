...
import {getSellerReportChartOptions, sellers, type SellerType} from '@/views/ecommerce/sellers/data'
...
const SellersCard = () => {
    const columns = [
        ...
        columnHelper.accessor('name', {
            ...
            cell: ({row}) => (
                <div className="d-flex align-items-center">
                    ...
                    <div>
                        <h5 className="mb-1">
                            <Link to="/sellers/1" className="link-reset">
                                {row.original.name}
                            </Link>
                        </h5>
        ...
        columnHelper.accessor('location', {
          ...
          <img src={row.original.flag} alt="flag" className="rounded-circle me-1" height={12}/> {row.original.location}
        </span>
            ),
        }),
