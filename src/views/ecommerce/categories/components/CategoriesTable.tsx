...
import {categoriesData,type CategoryType} from '../data.ts'
import AddCategoryModal from '@/views/ecommerce/categories/components/AddCategoryModal'
        ...
        columnHelper.accessor('name', {
            ...
            cell: ({row}) => (
                <div className="d-flex align-items-center">
                    ...
                    <div>
                        <h5 className="mb-0">
                            <Link to="/products/1" className="link-reset">
                                {row.original.name}
                            </Link>
                        </h5>
                    </div>
