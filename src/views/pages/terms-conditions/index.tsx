        ...
        <Col xxl={12}>
          <Card className="position-relative">
            <div className="position-absolute top-0 end-0">
              <svg
                style={{opacity: 0.05, width: "100%", height: "auto"}}
                width="600"
                height="560"
                viewBox="0 0 600 560"
                fill="none"
                ...
                <g clipPath="url(#clip0_948_1464)">
                  <mask id="mask0_948_1464" maskUnits="userSpaceOnUse" x="0" y="0" width="600" height="1200">
                    <path d="M0 0L0 1200H600L600 0H0Z" fill="white"></path>
                  </mask>
                  <g mask="url(#mask0_948_1464)">
                    <path d="M537.448 166.697L569.994 170.892L550.644 189.578L537.448 166.697Z" fill="#FF4C3E"></path>
                  </g>
                  <mask id="mask1_948_1464" maskUnits="userSpaceOnUse" x="0" y="0" width="600" height="1200">
                    <path d="M0 0L0 1200H600L600 0H0Z" fill="white"></path>
                  </mask>
                ...
                <defs>
                  <clipPath id="clip0_948_1464">
                    <rect width="560" height="600" fill="white" transform="matrix(0 -1 1 0 0 560)"></rect>
                  </clipPath>
                </defs>
              </svg>
            </div>
            ...
            <CardBody className="position-relative">
              <p className="fst-italic fs-sm">
                Welcome to our website. By accessing or using this site, you agree to be bound by these terms and conditions. Please read them
                carefully.
              </p>

              <h4 className="fw-bold mt-3">1. Acceptance of Terms</h4>
              <p>
                By using this website, you acknowledge that you have read, understood, and agree to be bound by these Terms and Conditions. If you do
                not agree, please do not use our services.
              </p>

              <h4 className="fw-bold mt-4">2. Modifications</h4>
              <p>
                We reserve the right to modify these Terms and Conditions at any time. Updated terms will be posted on this page with the revised
                date. Continued use constitutes acceptance of any changes.
              </p>

              <h4 className="fw-bold mt-4">3. Intellectual Property</h4>
              <p>
                All content, trademarks, graphics, and materials on this website are owned or licensed by us and protected by copyright and
              ...
              <p>
                All purchases are final unless otherwise specified. Refund requests will be considered on a case-by-case basis. Licensing fees may
                vary based on usage.
              </p>
              ...
              <p className="mt-4 mb-0">
                For any questions regarding these Terms, please contact us at <Link to="mailto:support@example.com">support@example.com</Link>.
              </p>
            </CardBody>
          </Card>
        </Col>
