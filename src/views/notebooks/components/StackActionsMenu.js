...
function StackActionsMenu({ stack, trigger }) {
  ...
  const menuId = `stack-menu-${stack.id}`;
  const buttonId = `stack-button-${stack.id}`;
    ...
    <>
      ...
      >
        <MenuItem onClick={handleRename} disableRipple>
          ...
          <ListItemText primary="Rename Stack" />
        </MenuItem>
        <MenuItem onClick={handleAddNotebook} disableRipple>
          <FuseSvgIcon>heroicons-outline:plus</FuseSvgIcon>
          <ListItemText primary="Add Notebook" />
        </MenuItem>
        <MenuItem onClick={handleDelete} disableRipple>
          <FuseSvgIcon>heroicons-outline:trash</FuseSvgIcon>
          <ListItemText primary="Delete Stack" />
        </MenuItem>
      </StyledMenu>
    </>
  );
