import FolderCards from '@/views/apps/file-manager/components/FolderCards'
import SideBar from '@/views/apps/file-manager/components/SideBar'
import {fileRecords,type FileRecordType} from '@/views/apps/file-manager/data'
    ...
    const columns = [
        ...
        columnHelper.accessor('email', {
            ...
            cell: ({row}) => (
                <div className="d-flex align-items-center gap-2">
                    <div
                        className="flex-shrink-0 bg-light bg-opacity-50 text-muted d-inline-flex align-items-center justify-content-center rounded-2">
                        <img src={row.original.avatar} height={24} width={24} alt=""
                ...
                <div className="avatar-group avatar-group-xs">
                    {row.original.sharedWith.map((item, index) => (
                        <div className="avatar" key={index}>
                            <img src={item.avatar} height={24} width={24} alt="" className="rounded-circle avatar-xs"/>
                        </div>
                    ))}
                </div>
            ),
                ...
                return (
                    <div className="d-flex align-items-center gap-2">
                        <button
                            ...
                            {isFavorite ? <TbStarFilled className="text-warning fs-lg"/> :
                                <TbStarFilled className="text-muted fs-lg"/>}
                        </button>
                        <Dropdown align="end" className="flex-shrink-0 text-muted">
                            <DropdownToggle as="a" role="button"
                                            className="dropdown-toggle drop-arrow-none fs-xxl link-reset p-0">
                                <TbDotsVertical/>
                            </DropdownToggle>
                            <DropdownMenu>
                                <DropdownItem>
                    ...
                    <CardHeader className="border-light justify-content-between">
                        <div className="d-flex gap-2">
                            <div className="d-lg-none d-inline-flex gap-2">
                                <button className="btn btn-default btn-icon" type="button"
