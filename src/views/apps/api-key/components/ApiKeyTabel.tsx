...
import { apiClients, type ApiClientType } from '@/views/apps/api-key/data'
        ...
        columnHelper.accessor('region', {
            ...
            cell: ({ row }) => (
                <span className="d-flex align-items-center fs-sm fw-bold">
                    <img src={row.original.regionFlag} height={12} width={12} alt="" className="rounded-circle me-1" /> {row.original.region}
                </span>
            ),
        }),
        {
