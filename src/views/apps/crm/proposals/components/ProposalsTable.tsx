...
import ProposalsModal from './ProposalsModal.tsx'
import {proposals,type ProposalType} from '../data.ts'
        ...
        columnHelper.accessor('sendTo', {
            ...
            , cell: ({row}) => (
                <div className="d-flex align-items-center">
                    <div
                        className="avatar-sm border flex-shrink-0 border-dashed rounded-circle me-2 justify-content-center d-flex align-items-center">
                        <img src={row.original.sendTo.logo} alt={row.original.sendTo.name} height={20}/>
                    </div>
