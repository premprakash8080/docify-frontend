...
import {invoices,type InvoiceType} from '@/views/apps/invoice/invoices/data'
                ...
                <div className="d-flex justify-content-start align-items-center gap-2">
                    {row.original.image ? (
                        ...
                        <div className="avatar-sm flex-shrink-0">
                            <span
                                className="avatar-title text-bg-primary fw-bold rounded-circle">{row.original.name.charAt(0)}</span>
                        </div>
                    )}
                    <div>
        ...
        <Card>
            <CardHeader className="border-light justify-content-between">
                <div className="d-flex gap-2">
                    ...
                    <Link to="/add-invoice" className="btn btn-secondary"><TbPlus
                        className="fs-lg me-1"></TbPlus> Create Invoice</Link>
                </div>
