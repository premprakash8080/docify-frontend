import type {CalendarFormType, SubmitEventType} from '@/types/calendar'
                    ...
                    <Row>
                        <Col sm={12}>
                            <FormGroup className="mb-2">
                                ...
                                <FormControl type="text" placeholder="Insert Event Name"
                                             isInvalid={!!errors.title} {...register('title')} />
