...
import {TbCheck, TbClock, TbDotsVertical, TbEdit, TbShieldLock, TbTrash} from 'react-icons/tb'
                    ...
                    <svg style={{ opacity: '0.075', width: '100%', height: 'auto' }} width={600} height={560} viewBox="0 0 600 560" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g clipPath="url(#clip0_948_1464)">
                            ...
                            <g mask="url(#mask1_948_1464)">
                                <path d="M364.093 327.517L332.306 359.304C321.885 369.725 304.989 369.725 294.568 359.304L262.781 327.517C252.36 317.096 252.36 300.2 262.781 289.779L294.568 257.992C304.989 247.571 321.885 247.571 332.306 257.992L364.093 289.779C374.514 300.2 374.514 317.096 364.093 327.517Z" stroke="#089df1" strokeWidth={2} strokeMiterlimit={10} />
                                <path d="M377.923 101.019L315.106 163.836C299.517 179.425 274.242 179.425 258.653 163.836L195.836 101.019C180.247 85.4301 180.247 60.1551 195.836 44.5661L258.653 -18.251C274.242 -33.84 299.517 -33.84 315.106 -18.251L377.923 44.5661C393.512 60.1551 393.512 85.4301 377.923 101.019Z" stroke="#089df1" strokeWidth={2} strokeMiterlimit={10} />
                                <path d="M696.956 -50.1542L650.648 -3.84605C635.059 11.743 609.784 11.743 594.195 -3.84605L547.887 -50.1542C532.298 -65.7432 532.298 -91.0182 547.887 -106.607L594.195 -152.915C609.784 -168.504 635.059 -168.504 650.648 -152.915L696.956 -106.607C712.545 -91.0172 712.545 -65.7432 696.956 -50.1542Z" stroke="#089df1" strokeWidth={2} strokeMiterlimit={10} />
                                <path d="M758.493 103.825L712.185 150.133C696.596 165.722 671.321 165.722 655.733 150.133L609.425 103.825C593.836 88.2359 593.836 62.9608 609.425 47.3718L655.733 1.06386C671.322 -14.5251 696.597 -14.5251 712.185 1.06386L758.493 47.3718C774.082 62.9608 774.082 88.2359 758.493 103.825Z" stroke="#089df1" strokeWidth={2} strokeMiterlimit={10} />
                                <path d="M674.716 80.202L501.67 253.248C486.081 268.837 460.806 268.837 445.217 253.248L272.171 80.202C256.582 64.613 256.582 39.338 272.171 23.749L445.217 -149.297C460.806 -164.886 486.081 -164.886 501.67 -149.297L674.716 23.75C690.305 39.339 690.305 64.613 674.716 80.202Z" stroke="#089df1" strokeWidth={2} strokeMiterlimit={10} />
                                <path d="M579.394 334.046L523.831 389.609C508.242 405.198 482.967 405.198 467.378 389.609L411.815 334.046C396.226 318.457 396.226 293.182 411.815 277.593L467.378 222.03C482.967 206.441 508.242 206.441 523.831 222.03L579.394 277.593C594.983 293.182 594.983 318.457 579.394 334.046Z" stroke="#089df1" strokeWidth={2} strokeMiterlimit={10} />
                                <path d="M185.618 87.2381L158.648 114.208C146.305 126.551 126.293 126.551 113.95 114.208L86.9799 87.2381C74.6369 74.8951 74.6369 54.883 86.9799 42.539L113.95 15.569C126.293 3.22605 146.305 3.22605 158.648 15.569L185.618 42.539C197.961 54.882 197.961 74.8941 185.618 87.2381Z" stroke="#089df1" strokeWidth={2} strokeMiterlimit={10} />
                                <path d="M249.319 23.767L228.859 44.227C221.817 51.269 210.4 51.269 203.358 44.227L182.898 23.767C175.856 16.725 175.856 5.30798 182.898 -1.73402L203.358 -22.194C210.4 -29.236 221.817 -29.236 228.859 -22.194L249.319 -1.73402C256.361 5.30798 256.361 16.725 249.319 23.767Z" stroke="#089df1" strokeWidth={2} strokeMiterlimit={10} />
                                <path d="M375.3 217.828L354.84 238.288C347.798 245.33 336.381 245.33 329.339 238.288L308.879 217.828C301.837 210.786 301.837 199.369 308.879 192.327L329.339 171.867C336.381 164.825 347.798 164.825 354.84 171.867L375.3 192.327C382.342 199.369 382.342 210.786 375.3 217.828Z" stroke="#089df1" strokeWidth={2} strokeMiterlimit={10} />
                                <path d="M262.326 229.367L255.702 235.991C252.281 239.412 246.734 239.412 243.313 235.991L236.689 229.367C233.268 225.946 233.268 220.399 236.689 216.978L243.313 210.354C246.734 206.933 252.281 206.933 255.702 210.354L262.326 216.978C265.747 220.399 265.747 225.946 262.326 229.367Z" stroke="#089df1" strokeWidth={2} strokeMiterlimit={10} />
                ...
                <CardBody className="d-flex flex-column justify-content-between">
                    <div className="d-flex mb-4">
                        <div className="flex-shrink-0">
                            <div className="avatar-xl rounded bg-primary-subtle d-flex align-items-center justify-content-center">
                                <TbShieldLock className="fs-24 text-primary" />
                            </div>
                        </div>
                        <div className="ms-3">
                            <h5 className="mb-1">Security Officer</h5>
                            <p className="text-muted mb-0 fs-base">Handles platform safety and protocol
                                reviews.</p>
                        </div>
                        <div className="ms-auto">
                            <Dropdown>
                                <DropdownToggle as={'a'} className="text-muted fs-xl drop-arrow-none" data-bs-toggle="dropdown">
                                    <TbDotsVertical />
                                </DropdownToggle>
                                <DropdownMenu align={'end'} className="dropdown-menu-end">
                                    <li><DropdownItem ><TbEdit className="me-2" />Edit</DropdownItem></li>
                                    <li><DropdownItem className=" text-danger" ><TbTrash className="me-2" />Remove</DropdownItem></li>
                                </DropdownMenu>
                            </Dropdown>
                        </div>
                    </div>
                    <ul className="list-unstyled mb-3">
                        <li className="d-flex align-items-center mb-2">
                            <TbCheck className="fs-lg text-success me-2" /> Daily Risk
                            Assessment
                        </li>
                        <li className="d-flex align-items-center mb-2">
                            <TbCheck className="fs-lg text-success me-2" /> Manage Security
                            Logs
                        </li>
                        <li className="d-flex align-items-center mb-2">
                            <TbCheck className="fs-lg text-success me-2" /> Control Access
                            Rights
                        </li>
                        <li className="d-flex align-items-center">
                            <TbCheck className="fs-lg text-success me-2" /> Emergency
                            Protocols
                        </li>
                    </ul>
                    ...
                    <div className="d-flex justify-content-between align-items-center">
                        <span className="text-muted fs-xs"><TbClock className="me-1" />Updated 1 hour ago</span>
                        <a  data-bs-toggle="modal" data-bs-target="#editRoleModal" onClick={toggle} className="btn btn-sm btn-outline-primary rounded-pill">Edit Role</a>
                    </div>
                </CardBody>
            </Card>
