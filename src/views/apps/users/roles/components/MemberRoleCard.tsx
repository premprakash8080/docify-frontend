import type {MemberRoleType} from '@/views/apps/users/roles/types'
            ...
            <div className="position-absolute top-0 end-0" style={{width: 180}}>
                <svg style={{opacity: '0.075', width: '100%', height: 'auto'}} width={600} height={560}
                    ...
                    <g clipPath="url(#clip0_948_1464)">
                        <mask id="mask0_948_1464" style={{maskType: 'luminance'}} maskUnits="userSpaceOnUse" x={0} y={0}
                        ...
                        <mask id="mask1_948_1464" style={{maskType: 'luminance'}} maskUnits="userSpaceOnUse" x={0} y={0}
                              width={600} height={1200}>
                            <path d="M0 0L0 1200H600L600 0H0Z" fill="white"/>
                        </mask>
                        <g mask="url(#mask1_948_1464)">
                            <path
                                ...
                                stroke="#089df1" strokeWidth={2} strokeMiterlimit={10}/>
                            <path
            ...
            <CardBody className="d-flex flex-column justify-content-between">
                <div className="d-flex mb-4">
                    <div className="flex-shrink-0">
                        <div
                            className="avatar-xl rounded bg-primary-subtle d-flex align-items-center justify-content-center">
                ...
                <ul className="list-unstyled mb-3">
                    {features.map((feature, idx) => (
                        <li className={`d-flex align-items-center ${idx !== features.length - 1 ? 'mb-2' : ''}`}
                            key={idx}>
                        ...
                        <Fragment key={idx}>
                            {idx < 4 && (
                                <div className="avatar">
                                    <img src={user} className="rounded-circle avatar-sm" alt={`user-${idx + 1}`}/>
                                </div>
                            )}
                        </Fragment>
                    ))}
                    {users.length > 4 && (
                        <OverlayTrigger overlay={<Tooltip>{users.length - 4} More</Tooltip>}>
                            <div className="avatar avatar-sm">
                                <span
                                    className="avatar-title text-bg-primary rounded-circle fw-bold"> +{users.length - 4}</span>
                            </div>
                        </OverlayTrigger>
                    )}
                </div>
