...
export const getBasicScatter = (): ApexOptions => ({
  chart: {
    height: 380,
    type: 'scatter',
    zoom: {
...
export const getDateTimeScatterChart = (): ApexOptions => ({
  chart: {
    height: 380,
    type: 'scatter',
    zoom: {
...
export const getImageScatterChart = (): ApexOptions => ({
  chart: {
    height: 380,
    type: 'scatter',
    animations: {
