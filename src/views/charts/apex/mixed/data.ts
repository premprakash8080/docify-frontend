...
export const getLineColumnChart = (): ApexOptions => ({
  chart: {
    height: 380,
    type: 'line',
    toolbar: {
...
export const getMultipleYaxisMixedChart = (): ApexOptions => ({
  chart: {
    height: 380,
    type: 'line',
    stacked: false,
...
export const getLineAreaChart = (): ApexOptions => ({
  chart: {
    height: 380,
    type: 'line',
    toolbar: {
...
export const getAllMixedChart = (): ApexOptions => ({
  chart: {
    height: 380,
    type: 'line',
    stacked: false,
