...
export const getBasicTreemapChart = (): ApexOptions => ({
  series: [
    {
      data: [
        { x: 'Electronics', y: 420 },
...
export const getTreemapMultipleChart = (): ApexOptions => ({
  series: [
    {
      name: 'Online',
      data: [
...
export const getDistributedTreemapChart = (): ApexOptions => ({
  series: [
    {
      data: [
        { x: 'Team Alpha', y: 91 },
...
export const getColorRangeTreemapChart = (): ApexOptions => ({
  series: [
    {
      data: [
        { x: 'Sales', y: 3.2 },
