import {countries, type CountryType} from '@/views/icons/flags/data'
...
const Index = () => {
    const columns = [
        columnHelper.accessor('flag', {
            header: 'Flag',
            cell: ({row}) => <img src={row.original.flag} alt={row.original.code} height={18} width={18}
                                  className="rounded"/>,
        }),
    ...
    const [data, _setData] = useState<CountryType[]>(() => [...countries])
