...
function NotesSection({ notebooks = [] }: NotesSectionProps) {
  ...
  // Display first 3 notes + 1 empty card for creating new note
      ...
      <CardBody>
        ...
        {!loading && displayNotes.length === 0 ? (
          <div className="text-center py-4">
            <p className="text-muted mb-3">No recent notes found</p>
                    ...
                    <div className="d-flex align-items-center gap-2 mb-2">
                      ...
                      <div className="flex-grow-1">
                        <p className="text-muted mb-0 fs-xs">
                          {notebooksArray.find((nb) => String(nb.id) === String(note.notebook_id))?.name || 'Note'}
                        </p>
                      </div>
                    </div>
