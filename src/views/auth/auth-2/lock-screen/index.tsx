  ...
  return (
    <div className="auth-box p-0 w-100">
      <Row className="w-100 g-0">
        <Col md={'auto'} className="col-md-auto">
          <Card className="auth-box-form border-0 mb-0">
            ...
            <CardBody className="min-vh-100 d-flex flex-column justify-content-center">
              ...
              <div className="mt-auto">
                <p className="text-muted text-center auth-sub-text mx-auto">Let’s get you signed in. Enter your password to continue.</p>
                <div className="text-center mb-4">
                  <img src={avatar} className="rounded-circle img-thumbnail avatar-xxl mb-2" alt="thumbnail" />
                  <h5 className="fs-md">Geneva K.</h5>
                </div>
                <form className="mt-4">
                  <div className="mb-3">
