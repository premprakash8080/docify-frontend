...
import userShield from '@/assets/images/user-shield.png'
              ...
              <div className="mt-auto">
                <form className="mt-4">
                  <div className="mb-4">
                    <div className="avatar-xxl mx-auto mt-2">
                      <div className="avatar-title bg-light-subtle border border-light border-dashed rounded-circle">
                        <img src={userShield} alt="dark logo" height={64} />
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="d-grid">
                    <Button type="submit" variant='primary' className="fw-semibold py-2">Reactivate Now</Button>
                  </div>
                </form>
              </div>
