  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (response.success) {
        ...
        setTimeout(() => {
          navigate('/auth-1/success-mail');
        }, 2000);
      }
    } catch (err: any) {
      setError(err.msg || 'Failed to send reset email. Please try again.');
    } finally {
      setLoading(false);
    }
  };
          ...
          <Col xxl={4} md={6} sm={8}>
            ...
            <Card className="p-4">
              ...
              <div className="auth-brand text-center mb-4">
                <AppLogo />
                <p className="text-muted w-lg-75 mt-3 mx-auto">Enter your email address and we&apos;ll send you a link to reset your password.</p>
              </div>
              ...
              <Form onSubmit={handleSubmit}>
                ...
                <div className="d-grid">
                  <Button type="submit" className="btn btn-primary fw-semibold py-2" disabled={loading || success}>
