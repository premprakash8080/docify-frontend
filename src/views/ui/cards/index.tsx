...
const CardWithActionToolsBgColor = () => {
    return (
        <ComponentCard title="Card with Action Tools & Background Colors" className='text-bg-dark border-0' headerClassName='border-light border-opacity-25' isCloseable isCollapsible isRefreshable>
            <CardText>With supporting text below as a natural lead-in to additional content.</CardText>
            <Link to="" className="btn btn-sm btn-light">
                Go somewhere
            </Link>
