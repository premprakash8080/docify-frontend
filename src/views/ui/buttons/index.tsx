...
const FocusRingUtilities = () => {
  return (
    <ComponentCard isCollapsible title="Focus Ring Utilities">
      ...
      <div className="d-flex flex-wrap gap-2">
        <Link to="" className="d-inline-flex focus-ring focus-ring-primary py-1 px-2 text-decoration-none border rounded-2">
          Primary focus
        </Link>
        <Link to="" className="d-inline-flex focus-ring focus-ring-secondary py-1 px-2 text-decoration-none border rounded-2">
          Secondary focus
        </Link>
        <Link to="" className="d-inline-flex focus-ring focus-ring-success py-1 px-2 text-decoration-none border rounded-2">
          Success focus
        </Link>
        <Link to="" className="d-inline-flex focus-ring focus-ring-danger py-1 px-2 text-decoration-none border rounded-2">
          Danger focus
        </Link>
        <Link to="" className="d-inline-flex focus-ring focus-ring-warning py-1 px-2 text-decoration-none border rounded-2">
          Warning focus
        </Link>
        <Link to="" className="d-inline-flex focus-ring focus-ring-info py-1 px-2 text-decoration-none border rounded-2">
          Info focus
        </Link>
        <Link to="" className="d-inline-flex focus-ring focus-ring-purple py-1 px-2 text-decoration-none border rounded-2">
          Purple focus
        </Link>
        <Link to="" className="d-inline-flex focus-ring focus-ring-light py-1 px-2 text-decoration-none border rounded-2">
          Light focus
        </Link>
        <Link to="" className="d-inline-flex focus-ring focus-ring-dark py-1 px-2 text-decoration-none border rounded-2">
          Dark focus
        </Link>
      </div>
    </ComponentCard>
