...
// Disabled mock API for tasks - using real backend API
...
// Updated regex to exclude getAllTasks, getTaskById, getNoteTasks, createTask, updateTask, toggleTaskComplete, deleteTask, reorder
mock.onGet(/\/api\/tasks\/(?!tags|getAllTasks|getTaskById|getNoteTasks|createTask|updateTask|toggleTaskComplete|deleteTask|reorder)[^/]+/).reply((config) => {
